...
public interface CompanyDAO {
	...
	void updateCompany(Company company) throws SQLException, ObjectDontExistException, Exception;
	Company getCompany(long id) throws SQLException, ObjectDontExistException, Exception;
